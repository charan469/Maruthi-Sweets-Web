...
const Home = () => {
    ...
    const handleIncreaseQuantity = (product: Product) => {
        const cartItem = cart.find((item: CartItem) => item.product_name === product.product_name);
        if (cartItem) {
            ...
            <main className="px-4 py-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    {availableProducts.map((product) => {
                        const cartItem: CartItem | undefined = cart.find((item: CartItem) => item.product_name === product.product_name);
                        return (
